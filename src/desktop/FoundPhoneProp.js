...
export function createFoundPhoneProp({ scene, camera, position = [-1.2, 0.07, -11.4], rotationY = 0 }) {
  ...
  root.rotation.set(-Math.PI / 2, Number.isFinite(rotationY) ? rotationY : 0, -0.34, "YXZ");
